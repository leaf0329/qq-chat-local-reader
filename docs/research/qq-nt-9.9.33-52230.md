...
- A seven-natural-day read over both configured acceptance conversation types found nonzero text, QQ-face, and reply segments. Every non-null body was valid Protobuf wire data; unsupported media and extension fields were reported as partial rather than treated as complete. No body text, reply summary, nickname, or conversation identifier was printed or recorded.
